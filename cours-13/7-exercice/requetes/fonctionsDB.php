<?php
	 ...
	 */
	function ajouteJoueur($prenom, $nom_famille, $numero, $id_equipe) {


		$query = "INSERT INTO joueurs (`prenom`, `nomFamille`, `numero`, `idEquipe`) 
				  VALUES ('" . $prenom . "','" . $nom_famille . "','" . $numero. "','" . $id_equipe . "')";
