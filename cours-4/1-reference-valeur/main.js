(function() {
    ...
    /**
     * En JavaScript, la variable contenant un objet est une référence à cet objet et non l’objet lui-même.
    ...
    (function() {
        ...
        console.log(objet1.item);               // => 'changé'  |  même si le passage d'un argument de fonction se fait toujours par valeur, les variable objet1 et b partage la référence au même objet ;
        console.log(objet2.item);               // => 'inchangé'  |  la valeur de la propriété item de l'objet est une variable de type primitif, donc passée par valeur.
    })();
